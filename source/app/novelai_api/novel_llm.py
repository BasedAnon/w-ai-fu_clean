...
class MockWebSocketServer:
    def __init__(self, host="127.0.0.1", port=8765):  # LLM uses port 8765
        self.host = host
        self.port = port
                    ...
                    while True:
                        ...
                        try:
                            ...
                            if "GENERATE" in msg_text:
                                # Send a mock text generation response
                                response = "TEXT This is a mock response from the LLM service. The real service requires installing websockets package."
